...
- [x] **Task 2: Extend Model State & Configuration**
  - **Action**: 
...
- [x] **Task 3: Implement Hetzner Streaming Provider in `SummaryService`**
  - **Action**:
...
- [x] **Task 4: Update Background Pipeline & Fallback Chain**
  - **Action**:
...
- [x] **Task 5: Update Frontend Options Scoping**
...
- [x] **Task 6: Add Unit & Integration Tests for Hetzner Provider**
...
- [x] **Task 7: Run Full Verification Suite**
...
- [x] **Task 8: Git Commit with Conventional Format**
...
- [x] **Task 9: Produce Walkthrough Document**
