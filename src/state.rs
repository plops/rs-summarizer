...
pub fn get_default_models() -> Vec<ModelOption> {
    vec![
        ...
        // 2. Gemini 3.6 Flash Lite (Text-out models)
        ModelOption {
            name: "gemini-3.6-flash-lite".to_string(),
        ...
        // 3. Gemini 3.5 Flash Lite (Text-out models)
        ModelOption {
        ...
        // 5. Gemma 4 31B (Mixture-of-Experts)
        ModelOption {
        ...
        // 6. Gemma 4 26B (Mixture-of-Experts)
        ModelOption {
        ...
        // 7. Gemini 3.1 Flash Lite (Text-out models)
        ModelOption {
        ...
        // 8. Gemini 2.5 Flash (Text-out models)
        ModelOption {
        ...
        // 9. Gemini 2.5 Flash Lite (Text-out models)
        ModelOption {
        ...
        // 10. Gemini 3 Flash Preview (Text-out models)
        ModelOption {
...
mod model_checks {
    ...
    fn test_updated_model_limits() {
        ...
        // Verify Gemini 3.6 Flash Lite limits
        let gemini_36_lite = models.iter().find(|m| m.name == "gemini-3.6-flash-lite").unwrap();
        assert_eq!(gemini_36_lite.rpm_limit, 15);
        assert_eq!(gemini_36_lite.rpd_limit, 500);
